...
export const alt = "L'Univers Parle — Iqraa";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

const articles = {
  "quran-ai-duality": quranAiDualityMeta,
} as const;
...
export default async function Image({
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Top row: imprint diamond + edition + year */}
        <div
          style={{
            display: "flex",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            ...
            />
            <div style={{ display: "flex" }}>Iqraa &middot; Lecture I</div>
          </div>
        ...
        {/* Center: massive Arabic + caption + title */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex" }}>Lis</div>
            <div style={{ display: "flex", color: "#8a6d35" }}>—</div>
          </div>
          <div
            style={{
          ...
          >
            <span>L&apos;Univers&nbsp;</span>
            <span style={{ color: "#e6c889" }}>Parle</span>
          </div>
          <div
            style={{
              display: "flex",
        ...
        {/* Bottom row: byline + verse-marker brackets */}
        <div
          style={{
            display: "flex",
            justifyContent: "space-between",
